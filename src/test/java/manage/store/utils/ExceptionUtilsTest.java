...
import manage.store.exception.common.InternalErrorException;
...
class ExceptionUtilsTest {
    ...
    void getExceptionErrorMsg_success() {
        ...
        try{
            ...
            assertThat(exceptionErrorMsg.contains("manage.store.exception.common.InternalErrorException: test exception"));
        }
    }
}